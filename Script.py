...
ᴘʟᴇᴀꜱᴇ ꜱᴇɴᴅ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛ ᴀɢᴀɪɴ."""
    ...
    CUDNT_FND = """<b><blockquote>🙅🏻‍♂️ 𝐒𝐩𝐞𝐥𝐥𝐢𝐧𝐠 𝐌𝐢𝐬𝐭𝐚𝐤𝐞 𝐁𝐫𝐨 ‼️
𝐃𝐨𝐧'𝐭 𝐖𝐨𝐫𝐫𝐲 😌, 𝐂𝐡𝐨𝐨𝐬𝐞 𝐓𝐡𝐞 𝐂𝐨𝐫𝐫𝐞𝐜𝐭 𝐎𝐧𝐞 𝐁𝐞𝐥𝐨𝐰👇</blockquote></b>"""
...
💠 ᴇxᴀᴍᴘʟᴇ : Jawan / Jawan 2023 / Jawan 2023 Hin

<blockquote>🔻 ꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ 🔻</blockquote>

💠 ᴇxᴀᴍᴘʟᴇ : Loki S01 / Loki S01 Hin / Loki tam
...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs</b>"""
    ...
    MVE_NT_FND = """<b><blockquote>𝐓𝐡𝐢𝐬 𝐌𝐨𝐯𝐢𝐞 𝐈𝐬 𝐍𝐨𝐭 𝐅𝐨𝐮𝐧𝐝 𝐈𝐧 𝐌𝐲 𝐃𝐚𝐭𝐚𝐛𝐚𝐬𝐞...🐸</blockquote></b>"""
...
<b>ᴘʟᴇᴀsᴇ ᴅᴏɴᴀᴛᴇ ᴛʜᴇ ᴅᴇᴠᴏʟᴏᴘᴇʀ ғᴏʀ ᴋᴇᴇᴘɪɴɢ ᴛʜᴇ sᴇʀᴠɪᴄᴇ ᴀʟɪᴠᴇ ᴀɴᴅ ᴋᴇᴇᴘ ʙʀɪɴɢɪɴɢ ᴍᴏʀᴇ ɴᴇᴡ ғᴇᴀᴛᴜʀᴇs ғᴏʀ ʏᴏᴜ ☺️
ɪᴛ ᴡɪʟʟ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴏᴜʀ ʙᴏᴛ ᴄᴏɴᴛɪɴᴜᴏᴜsʟʏ ʀᴜɴɴɪɴɢ ᴡɪᴛʜᴏᴜᴛ ʜᴇsɪᴛᴀᴛɪᴏɴ sᴏ ᴛʜᴀᴛ ᴡᴇ ᴄᴀɴ ᴋᴇᴇᴘ ᴜᴘʟᴏᴀᴅɪɴɢ ᴍᴏᴠɪᴇs ᴀɴᴅ ᴡᴇʙsᴇʀɪᴇs ɴᴏɴ-sᴛᴏᴘ ɪɴ ʙᴇsᴛ ǫᴜᴀʟɪᴛɪᴇs...🙏<b>
<b>ʏᴏᴜ ᴄᴀɴ ᴅᴏɴᴀᴛᴇ ᴀɴʏ ᴀᴍᴏᴜɴᴛ ʏᴏᴜ ʜᴀᴠᴇ 😗<b>
<b>🎉 sᴇʟᴇᴄᴛ ʏᴏᴜʀ ᴅᴏɴᴀᴛɪᴏɴ ᴍᴇᴛʜᴏᴅ ⤵️</b>

<blockquote>⚡ ǫʀ ᴄᴏᴅᴇ : <a href='{}'>𝐂𝐥𝐢𝐜𝐤 𝐇𝐞𝐫𝐞 𝐓𝐨 𝐒𝐜𝐚𝐧</a>

⚡ ᴜᴘɪ ɪᴅ : <code>{}</code></blockquote>

🕊️ ᴍᴜsᴛ sᴇɴᴅ sᴄʀᴇᴇɴsʜᴏᴛ ᴀғᴛᴇʀ ᴅᴏɴᴀᴛᴇ..💰</b>"""
...
› ʟɪᴋᴇ ᴛʜɪꜱ :</b>  <code>/shortlink instantlink.co 1502a197c9d50f1cba1d5e6f967d1e962</code>
...
› ʟɪᴋᴇ ᴛʜɪꜱ :</b> <code>/set_tutorial https://t.me/ZoneFlixTv</code>
...
👨‍💻 ᴄᴏɴᴛᴀᴄᴛ ᴛʜᴇ <a href='https://t.me/ZAYOTA'>𝐎𝐖𝐍𝐄𝐑</a> ᴛᴏ ɢᴇᴛ ʏᴏᴜʀ ᴛʀɪᴀʟ.
...
😌 ᴘʀɪᴄᴇ ᴡɪʟʟ ʙᴇ ɴᴇɢᴏᴛɪᴀʙʟᴇ ғᴏʀ 𝟹𝟶 ᴅᴀʏs ᴘʟᴀɴ ᴀɴᴅ ᴀʙᴏᴠᴇ, ᴄᴏɴᴛᴀᴄᴛ ᴡɪᴛʜ <a href='https://t.me/ZAYOTA'>𝐎𝐖𝐍𝐄𝐑</a>✨
