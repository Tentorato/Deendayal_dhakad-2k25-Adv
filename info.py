...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1722409366').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001973645984').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002000438745'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002000438745'))  # Bin channel id (make sure bot is admin)
DEENDAYAL_MOVIE_UPDATE_CHANNEL = int(environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL', '-1002257418506'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002000438745'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002335828349')  # Support group id (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/axK.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', '@ZAYOTA')
...
DEENDAYAL_VERIFIED_LOG = int(environ.get('DEENDAYAL_VERIFIED_LOG', '-1002000438745'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/ZoneFlixTv')  # How to open tutorial link for verification
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'c6b16cbd3adbb5ebf95d161c87b5d1dd6b73cc3e')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/hwtododk/14')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+UPN7n0ItgKI3YWJl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ZoneFlixTv')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/ZAYOTA')
DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK = environ.get('DEENDAYAL_MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+anmk0YYnvRA1ZjNl')
OWNERID = int(os.environ.get('OWNERID', '1722409366'))  # Replace with the actual admin ID
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+UPN7n0ItgKI3YWJl')  # Support group link (make sure bot is admin)
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002000438745')).split()]
